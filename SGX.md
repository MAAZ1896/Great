# How to Validate Author Using SGX
...
7. Verify the copyrights from the list of last three books. If copyrights are updated click  **Invalid** if not click **Valid**.
...
### CONTACT CUSTOMER CARE FOR DETAILED DISCUSSION.
![alt text](amazon.png)
